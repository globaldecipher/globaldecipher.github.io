...
export const DISTRICTS = [
  ...
  { terms: ["mohmand"], district: "Mohmand", province: "Khyber Pakhtunkhwa", lat: 34.52, lng: 71.38 },
  { terms: ["lower dir", "chakdara"], district: "Lower Dir", province: "Khyber Pakhtunkhwa", lat: 34.85, lng: 71.83 },
  { terms: ["upper dir"], district: "Upper Dir", province: "Khyber Pakhtunkhwa", lat: 35.21, lng: 71.87 },
  { terms: ["swat", "mingora"], district: "Swat", province: "Khyber Pakhtunkhwa", lat: 35.22, lng: 72.43 },
  { terms: ["shangla"], district: "Shangla", province: "Khyber Pakhtunkhwa", lat: 34.89, lng: 72.6 },
  { terms: ["buner"], district: "Buner", province: "Khyber Pakhtunkhwa", lat: 34.39, lng: 72.62 },
  { terms: ["malakand"], district: "Malakand", province: "Khyber Pakhtunkhwa", lat: 34.56, lng: 71.93 },
  { terms: ["orakzai"], district: "Orakzai", province: "Khyber Pakhtunkhwa", lat: 33.7, lng: 70.98 },
  { terms: ["kohat"], district: "Kohat", province: "Khyber Pakhtunkhwa", lat: 33.59, lng: 71.44 },
  { terms: ["nowshera"], district: "Nowshera", province: "Khyber Pakhtunkhwa", lat: 34.01, lng: 71.98 },
  { terms: ["mardan"], district: "Mardan", province: "Khyber Pakhtunkhwa", lat: 34.2, lng: 72.05 },
  ...
  { terms: ["gwadar", "jiwani", "panwan"], district: "Gwadar", province: "Balochistan", lat: 25.12, lng: 62.33 },
  ...
  { terms: ["panjgur"], district: "Panjgur", province: "Balochistan", lat: 26.97, lng: 64.09 },
  { terms: ["awaran"], district: "Awaran", province: "Balochistan", lat: 26.46, lng: 65.23 },
  { terms: ["washuk"], district: "Washuk", province: "Balochistan", lat: 27.72, lng: 64.8 },
  { terms: ["kalat"], district: "Kalat", province: "Balochistan", lat: 29.03, lng: 66.59 },
  { terms: ["mastung"], district: "Mastung", province: "Balochistan", lat: 29.8, lng: 66.84 },
  { terms: ["pishin"], district: "Pishin", province: "Balochistan", lat: 30.58, lng: 67 },
  { terms: ["chaman"], district: "Chaman", province: "Balochistan", lat: 30.92, lng: 66.45 },
  { terms: ["zhob"], district: "Zhob", province: "Balochistan", lat: 31.34, lng: 69.45 },
  { terms: ["loralai"], district: "Loralai", province: "Balochistan", lat: 30.37, lng: 68.6 },
  { terms: ["duki"], district: "Duki", province: "Balochistan", lat: 30.15, lng: 68.57 },
  { terms: ["harnai"], district: "Harnai", province: "Balochistan", lat: 30.1, lng: 67.94 },
  { terms: ["sibi"], district: "Sibi", province: "Balochistan", lat: 29.55, lng: 67.88 },
  { terms: ["kachhi", "bolan"], district: "Kachhi", province: "Balochistan", lat: 29.5, lng: 67.5 },
  { terms: ["killa abdullah", "qilla abdullah"], district: "Killa Abdullah", province: "Balochistan", lat: 30.65, lng: 66.66 },
  { terms: ["killa saifullah", "qilla saifullah"], district: "Killa Saifullah", province: "Balochistan", lat: 30.7, lng: 68.37 },
  { terms: ["dera bugti"], district: "Dera Bugti", province: "Balochistan", lat: 29.04, lng: 69.16 },
  { terms: ["kohlu"], district: "Kohlu", province: "Balochistan", lat: 29.9, lng: 69.25 },
  { terms: ["lasbela", "hub"], district: "Lasbela", province: "Balochistan", lat: 26, lng: 66.6 },
  ...
  { terms: ["shikarpur"], district: "Shikarpur", province: "Sindh", lat: 27.96, lng: 68.64 },
  { terms: ["jacobabad"], district: "Jacobabad", province: "Sindh", lat: 28.28, lng: 68.44 },
  { terms: ["sukkur"], district: "Sukkur", province: "Sindh", lat: 27.71, lng: 68.86 },
  ...
  { terms: ["rajanpur"], district: "Rajanpur", province: "Punjab", lat: 29.1, lng: 70.33 },
  { terms: ["mianwali"], district: "Mianwali", province: "Punjab", lat: 32.58, lng: 71.54 },
  { terms: ["rawalpindi"], district: "Rawalpindi", province: "Punjab", lat: 33.57, lng: 73.04 },
  { terms: ["bahawalpur"], district: "Bahawalpur", province: "Punjab", lat: 29.4, lng: 71.68 },
